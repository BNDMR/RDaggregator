...
### Check options
As Orphanet publishes its data on a regular basis and in various language versions, you should first check if options are correctly set: 
```{r options, eval=F}
...
### Analyze genealogy
`RDaggregator` and `igraph` provide useful functions to analyze the Orphanet classification system.
